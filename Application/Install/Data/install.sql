...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-07-04 03:23:27
-- 服务器版本： 5.6.22
-- PHP Version: 5.6.7
...
CREATE TABLE IF NOT EXISTS `common_action` (
...
--
-- 转存表中的数据 `common_action`
--

INSERT INTO `common_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
(1, 'user_login', '用户登录', '积分+10，每天一次', 'table:member|field:score|condition:uid={$self} AND status>-1|rule:score+10|cycle:24|max:1;', '[user|get_nickname]在[time|time_format]登录了后台', 1, 1, 1433411242),
(2, 'add_article', '发布文章', '积分+5，每天上限5次', 'table:member|field:score|condition:uid={$self}|rule:score+5|cycle:24|max:5', '', 2, -1, 1433411772),
(3, 'review', '评论', '评论积分+1，无限制', 'table:member|field:score|condition:uid={$self}|rule:score+1', '', 2, -1, 1433411859),
(6, 'update_config', '更新配置', '新增或修改或删除配置', '', '', 2, 1, 1433411818);
...
CREATE TABLE IF NOT EXISTS `common_action_log` (
...
CREATE TABLE IF NOT EXISTS `common_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='插件表' AUTO_INCREMENT=23 ;

--
-- 转存表中的数据 `common_addons`
--

INSERT INTO `common_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
(2, 'SiteStat', '站点统计信息', '统计站点的基础信息', 1, '{"title":"\\u7cfb\\u7edf\\u4fe1\\u606f","width":"6","display":"1"}', 'thinkphp', '0.1', 1379512015, 0),
(4, 'SystemInfo', '系统环境信息', '用于显示一些服务器的信息', 1, '{"title":"\\u7cfb\\u7edf\\u4fe1\\u606f","width":"6","display":"1"}', 'thinkphp', '0.1', 1379512036, 0),
(22, 'WeixinMsgSend', '微信公众号消息发送插件', '给指定微信用户发送一条消息', 1, '{"cnt":"1"}', 'hebidu', '0.1', 1435917278, 1),
...
(16, 'ReturnTop', '返回顶部', '回到顶部美化，随机或指定显示，100款样式，每天一种换，天天都用新样式', 1, '{"random":"0","current":"40"}', 'thinkphp', '0.1', 1414395258, 0);
...
CREATE TABLE IF NOT EXISTS `common_auth_group` (
  ...
  `menulist` varchar(512) NOT NULL COMMENT '可视菜单ID集合',
...
(1, '管理员', 1, '17,16,13,7,9,8,17,16,13,7,9,8', '184,183,182,168,169,170,165,171,166,172,173,174,167,164,178,179,176,186,185,175,189,192,188,191,193,190,200,201,199,203,202,187,198,197,196,', '后台操作员，需要了解整个系统的大体流程。'),
(4, '后台操作员', 1, '', '168,165,164,171,166,166,172,167,189,188,187,192,188,191,190,193,190,200,199,201,199,203,202,202,187,220,215,214,225,224,219,218,218,226,215,214,', '后台操作员');
...
(9, 'CONFIG_TYPE_LIST', 3, '配置类型列表', 4, '', '主要用于数据解析和页面表单的生成', 1378898976, 1435743903, 1, '0:数字\r\n1:字符\r\n2:文本\r\n3:数组\r\n4:枚举\r\n5:图片', 2),
...
(20, 'CONFIG_GROUP_LIST', 3, '配置分组', 4, ' e', '配置分组', 1379228036, 1384418383, 1, '5:分销系统\r\n1:基本\r\n2:内容\r\n3:用户\r\n4:系统\r\n', 1),
...
(43, 'DEFAULT_SKIN', 4, '默认皮肤', 4, '0:simplex\n1:flatly\n2:darkly\n3:cosmo\n4:paper\n5:slate\n6:superhero\n7:united\n8:yeti\n9:spruce\n10:readable\n11:cyborg\n12:cerulean', '系统皮肤', 1420435487, 1420435487, 1, '12', 3),
...
(46, 'SITE_URL', 1, '站点URL地址', 1, '', '末尾不包含/符号，例如：http://localhost', 1426478195, 1426478195, 1, 'http://localhost/github/20150606renren', 4),
(47, 'SS_KEYWORD', 1, '首次关注时回复关键词', 5, '', '首次关注时回复的关键词', 1426664990, 1426664990, 1, '首页', 0),
(48, 'BRAND_NAME', 0, '品牌名称', 5, '', '通常为产品品牌', 1427369760, 1427369760, 1, '杭州博也', 0),
(51, 'HOOKS_TYPE', 3, '钩子类型', 1, '', '类型 1-用于扩展显示内容，2-用于扩展业务处理', 1435716893, 1435716893, 1, '1:视图\r\n2:控制器', 0),
(52, 'ADMIN_LOGO', 5, '后台顶部LOGO', 1, '', '后台做上角顶部LOGO，150px*40px,底色与顶部一致', 1435743870, 1435744002, 1, '', 0);
...
CREATE TABLE IF NOT EXISTS `common_datatree` (
  ...
  `level` tinyint(3) NOT NULL DEFAULT '0' COMMENT '所处层级',
  `iconurl` varchar(256) DEFAULT NULL COMMENT '小图标地址\r\n',
  PRIMARY KEY (`id`)
...
INSERT INTO `common_datatree` (`id`, `code`, `name`, `sort`, `createtime`, `updatetime`, `parents`, `parentid`, `notes`, `level`, `iconurl`) VALUES
(2, '', '店铺类别', 2, 1429494339, 1429494755, '0,', 0, '备注', 0, NULL),
(9, '', '烟酒', 0, 1429495939, 1429495939, '0,2,', 2, '', 1, NULL),
(10, '', '服饰', 0, 1429496009, 1429496009, '0,2,', 2, '', 1, NULL),
(11, '', '食品', 0, 1429498086, 1429498087, '0,2,', 2, '', 1, NULL),
(12, '', '批发', 0, 1429498098, 1429498099, '0,2,9,', 9, '', 2, NULL),
(13, '', '商品分组', 0, 1429501796, 1429501796, '0,', 0, '', 0, NULL),
(14, '', '最新商品', 0, 1429501808, 1429501808, '0,13,', 13, '', 1, NULL),
(15, '', '热门商品', 0, 1429501817, 1429501817, '0,13,', 13, '', 1, NULL),
(16, '', '推荐商品', 0, 1429501832, 1429501832, '0,13,', 13, '', 1, NULL),
(17, '', 'Banners类别', 0, 1429615912, 1429615912, '0,', 0, 'Banners类别', 0, NULL),
(18, '', '商城首页Banners', 0, 1429616035, 1429616035, '0,17,', 17, '商城首页Banners', 1, NULL),
(19, '', ' 首页4格广告', 0, 1429665929, 1429665929, '0,17,', 17, ' 首页4格广告', 1, NULL),
(21, '', '文章分类', 0, 1429707419, 1429707419, '0,', 0, '', 0, ''),
(22, '', '商城公告', 0, 1429707434, 1429707434, '0,21,', 21, '', 1, ''),
(23, '', '首页活动格子01', 0, 1429757956, 1429757956, '0,13,', 13, '首页活动格子01', 1, ''),
(24, '', '首页活动格子02', 0, 1429757962, 1429757962, '0,13,', 13, '', 1, ''),
(25, '', '首页活动格子03', 0, 1429757969, 1429757969, '0,13,', 13, '', 1, ''),
(26, '', '首页活动格子04', 0, 1429757975, 1429757975, '0,13,', 13, '', 1, ''),
(27, '', '可支持提现银行', 0, 1435819737, 1435819737, '0,', 0, '', 0, ''),
(28, '', '支付宝', 0, 1435819745, 1435819745, '0,27,', 27, '', 1, ''),
(29, '', '微信', 0, 1435819752, 1435819752, '0,27,', 27, '', 1, ''),
(30, '', '工商银行', 0, 1435819763, 1435819763, '0,27,', 27, '', 1, '');
...
CREATE TABLE IF NOT EXISTS `common_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- 转存表中的数据 `common_hooks`
--

INSERT INTO `common_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`, `status`) VALUES
(1, 'pageHeader', '页面header钩子，一般用于加载插件CSS文件和代码', 1, 0, '', 1),
(2, 'pageFooter', '页面footer钩子，一般用于加载插件JS文件和JS代码', 1, 0, 'ReturnTop', 1),
(17, 'send_msg_to_user', '发送关键消息', 1, 1435916075, 'WeixinMsgSend', 1),
(18, 'WeixinInnerProcess', '微信关键词处理，内部无法处理时，', 1, 1435979368, 'WeixinPromotion', 1),
(13, 'admin_index', '后台首页小格子个性化显示', 1, 1435723166, 'SiteStat,SystemInfo', 1),
...
CREATE TABLE IF NOT EXISTS `common_log` (
  ...
  FULLTEXT KEY `request_uri_2` (`request_uri`)
...
(1, 'itboye', '', 'itboye', 0, 0, '', 40, 1, 0, 1433570548, 0, 1433570548, 1433570548, 1);
...
(233, '插件管理', 232, 0, '#', 0, '', '', 0, 1),
(232, '插件', 0, 10, 'Admin/Addons/index', 0, '', '', 0, 1),
(165, '配置模块', 164, 10, '#', 0, '', '', 0, 1),
(166, '日志模块', 164, 5, '#', 0, '', '', 0, 1),
(167, '系统工具', 164, 0, '#', 0, '', '', 0, 1),
(164, '系统', 0, 100, 'Admin/Config/set', 0, '系统.', '', 0, 1),
...
(175, '用户', 0, 30, 'Admin/Member/index', 0, '', '', 0, 1),
(176, '用户管理', 175, 0, '#', 0, '', '', 0, 1),
(178, '用户信息', 176, 1, 'Admin/Member/index', 0, '用户信息', '', 0, 1),
(179, '权限管理', 176, 0, 'Admin/AuthGroup/index', 0, '', '', 0, 1),
(185, '接口列表', 175, 0, '#', 0, '', '', 0, 1),
(186, '接口管理', 185, 1, 'javascript:alertTODO()', 0, '管理方法操作', '', 0, 1),
(187, '微信', 0, 40, 'Admin/Wxaccount/edit', 0, '微信管理模块', '', 0, 1),
(188, '公众号管理', 187, 0, '#', 0, '', '', 0, 1),
(189, '公众号资料', 188, 0, 'Admin/Wxaccount/edit', 0, '', '', 0, 1),
(190, '基础模块', 187, 0, '#', 0, '', '', 0, 1),
(191, '自定义回复', 190, 0, 'Admin/WxreplyText/index', 0, '', '', 0, 1),
(192, '公众号绑定', 188, 0, 'Admin/Wxaccount/help', 0, '', '', 0, 1),
(193, '自定义菜单', 190, 0, 'Admin/Wxmenu/index', 0, '', '', 0, 1),
(196, '商城', 0, 100, 'Admin/Orders/statics', 0, '', '', 0, 1),
(197, '商品模块', 196, 0, '#', 0, '', '', 0, 1),
(198, '商品管理', 197, 0, 'Admin/WxshopProduct/index', 1, '', '', 0, 1),
(199, '会员模块', 187, 0, '#', 0, '', '', 0, 1),
(200, '会员管理', 199, 0, 'Admin/Wxuser/index', 0, '', '', 0, 1),
(201, '会员组管理', 199, 0, 'Admin/WxuserGroup/index', 0, '', '', 0, 1),
(202, '日志模块', 187, 0, '#', 0, '', '', 0, 1),
(203, '微信交互日志', 202, 0, 'Admin/WeixinLog/index', 0, '', '', 0, 1),
(204, '订单模块', 196, 0, '#', 0, '', '', 0, 1),
(205, '订单查询', 204, 10, 'Admin/Orders/index', 0, '', '', 0, 1),
(206, '发货管理', 204, 15, 'Admin/Orders/deliverGoods', 0, '发货', '', 0, 1),
(207, '佣金模块', 196, 0, '#', 1, '', '', 0, 1),
(208, '提现审核', 207, 0, 'Admin/CommWithdrawcash/index', 0, '提现审核', '', 0, 1),
(209, '提现历史查询', 207, 0, 'Admin/CommWithdrawcash/query', 0, '', '', 0, 1),
(210, '确认订单', 204, 30, 'Admin/Orders/sure', 0, '确认订单', '', 0, 1),
(211, '退货管理', 204, 12, 'Admin/Orders/returned', 0, '退货', '', 0, 1),
(212, '对账单下载', 204, 0, 'Admin/Wxpay/downloadBill', 1, '', '', 0, 1),
(234, '插件列表', 233, 0, 'Admin/Addons/index', 0, '', '', 0, 1),
(235, '钩子管理', 233, 0, 'Admin/Addons/hooks', 0, '', '', 0, 1),
(236, '店铺管理', 197, 0, 'Admin/Store/index', 0, '', '', 0, 1),
(243, '分销', 0, 15, 'Admin/Index/distribution', 0, '', '', 0, 1),
(237, '佣金模块', 230, 0, '#', 0, '', '', 0, 1),
(238, '提现审核', 237, 0, 'Admin/Withdraw/verify', 0, '', '', 0, 1),
(223, '数据字典', 165, 0, 'Admin/Datatree/index', 0, '', '', 0, 1),
(239, '提现历史查询', 237, 0, 'Admin/Withdraw/query', 0, '', '', 0, 1),
(227, '用户行为', 176, 0, 'Admin/Action/index', 0, '', '', 0, 1),
(228, '行为日志', 176, 0, 'Admin/ActionLog/index', 0, '', '', 0, 1),
(229, '类目管理', 197, 0, 'Admin/Category/index', 0, '商品的类目（比如衣服、电器等）', '', 0, 1),
(230, '财务', 0, 20, 'Admin/Index/tradeIndex', 0, '', '', 0, 1),
(240, '商城模块', 196, 10, '#', 0, '', '', 0, 1),
(241, '商城设置', 240, 0, 'Admin/Wxshop/config', 0, '', '', 0, 1),
(242, '图片链接管理', 240, 0, 'Admin/Banners/index', 0, '', '', 0, 1),
(244, '分销模块', 243, 0, '#', 0, '', '', 0, 1),
(245, '分销商管理', 244, 0, 'Admin/Wxuser/distribution', 0, '', '', 0, 1),
(246, '分销权限管理', 244, 0, 'Admin/WxuserGroup/index', 0, '', '', 0, 1);
...
CREATE TABLE IF NOT EXISTS `common_province` (
  ...
  `countryid` int(11) NOT NULL DEFAULT '1017',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `itboye_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wxuserid` int(11) NOT NULL COMMENT '用户id',
  `country` varchar(32) NOT NULL COMMENT '国家',
  `city` varchar(64) NOT NULL COMMENT '城市',
  `province` varchar(64) NOT NULL COMMENT '省',
  `detailinfo` varchar(256) NOT NULL COMMENT '详细地址',
  `area` varchar(64) NOT NULL COMMENT '区域',
  `contactname` varchar(32) NOT NULL DEFAULT '' COMMENT '联系人姓名',
  `mobile` char(15) NOT NULL DEFAULT '' COMMENT '电话',
  `wxno` varchar(32) NOT NULL DEFAULT '' COMMENT '微信号',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `itboye_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `img` varchar(256) NOT NULL COMMENT '图片地址',
  `position` varchar(45) NOT NULL COMMENT '位置（固定：动态：）',
  `notes` varchar(128) NOT NULL COMMENT '备注',
  `uid` int(11) NOT NULL,
  ...
  `starttime` int(11) NOT NULL COMMENT '生效时间',
  `endtime` int(11) NOT NULL COMMENT '结束时间',
  `noticetime` int(11) NOT NULL COMMENT '通知时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `itboye_banners`
--

-- --------------------------------------------------------

--
-- 表的结构 `itboye_category`
--

CREATE TABLE IF NOT EXISTS `itboye_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL COMMENT '分类名',
  `cate_id` char(16) NOT NULL COMMENT '分类ID',
  `parent` char(16) NOT NULL DEFAULT '1' COMMENT '父ID',
  `level` tinyint(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `itboye_category`
--

INSERT INTO `itboye_category` (`id`, `name`, `cate_id`, `parent`, `level`) VALUES
(1, '茶/酒/冲饮', 'custom', '0', 1),
(2, '咖啡', 'custom', '1', 2);
...
--
-- 表的结构 `itboye_category_prop`
--

CREATE TABLE IF NOT EXISTS `itboye_category_prop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `itboye_category_prop`
--

INSERT INTO `itboye_category_prop` (`id`, `propid`, `propname`, `cate_id`) VALUES
(1, 0, '品牌', 2),
(2, 0, '产地', 2);
...
--
-- 表的结构 `itboye_category_propvalue`
--

CREATE TABLE IF NOT EXISTS `itboye_category_propvalue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `propvalueid` int(11) NOT NULL,
  `valuename` varchar(126) NOT NULL,
  `prop_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;

--
-- 转存表中的数据 `itboye_category_propvalue`
--

INSERT INTO `itboye_category_propvalue` (`id`, `propvalueid`, `valuename`, `prop_id`) VALUES
(1, 0, '奥肯多OQUENDO', 1),
(2, 0, '雀巢', 1),
(3, 0, '中国大陆', 2),
(4, 0, '美国', 2),
...
--
-- 表的结构 `itboye_group_access`
--

CREATE TABLE IF NOT EXISTS `itboye_group_access` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alloweddistribution` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否允许分销',
  `allowedcomment` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否允许评论',
  `percent` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '佣金提成比例',
  `wxuser_group_id` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cjfx_group_access_cjfx_wxuser_group1_idx` (`wxuser_group_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;

--
-- 转存表中的数据 `itboye_group_access`
--

INSERT INTO `itboye_group_access` (`id`, `alloweddistribution`, `allowedcomment`, `percent`, `wxuser_group_id`) VALUES
(2, 1, 1, '0.15', 11),
(3, 0, 1, '0.00', 0),
(4, 0, 1, '0.10', 12),
(5, 1, 1, '0.05', 13);
...
--
-- 表的结构 `itboye_msg_send_his`
--

CREATE TABLE IF NOT EXISTS `itboye_msg_send_his` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `itboye_msg_send_his`
--

INSERT INTO `itboye_msg_send_his` (`id`, `msg_title`, `msg_desc`, `create_time`, `send_time`, `to_user`, `from`, `phone`, `email`, `status`) VALUES
(1, '123', '123456', 0, 0, 1, 1, '1', '1', 1);
...
CREATE TABLE IF NOT EXISTS `itboye_orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wxuser_id` int(11) NOT NULL COMMENT '下单用户id',
  `orderid` char(64) NOT NULL COMMENT '精确到秒，毫秒\n',
  ...
  `order_status` tinyint(2) NOT NULL COMMENT '订单状态（待确认，未发货，已发货，已完成，已退货）',
  `createtime` int(10) unsigned NOT NULL COMMENT '创建时间',
  `updatetime` int(10) unsigned NOT NULL COMMENT '更新时间',
  `status_note` varchar(256) NOT NULL DEFAULT '' COMMENT '状态变更备注',
  `wxaccountid` int(11) unsigned NOT NULL COMMENT '公众号ID',
  PRIMARY KEY (`id`),
  UNIQUE KEY `ordersid` (`orderid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `itboye_orders_contactinfo`
--

CREATE TABLE IF NOT EXISTS `itboye_orders_contactinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `contactname` varchar(64) NOT NULL COMMENT '联系人姓名',
  `wxuser_id` int(11) NOT NULL COMMENT '用户id',
  `country` varchar(32) NOT NULL COMMENT '国家',
  `province` varchar(64) NOT NULL COMMENT '省份',
  `detailinfo` varchar(256) NOT NULL COMMENT '详细',
  `area` varchar(64) NOT NULL COMMENT '区域',
  `mobile` char(15) NOT NULL COMMENT '联系电话',
  `notes` varchar(64) NOT NULL COMMENT '备注',
  `wxno` varchar(64) NOT NULL COMMENT '微信号',
  `orderid` char(64) NOT NULL COMMENT '订单编号',
...
--
-- 表的结构 `itboye_orders_express`
--

CREATE TABLE IF NOT EXISTS `itboye_orders_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `expresscode` char(16) NOT NULL COMMENT '发货快递公司编码',
  `expressname` varchar(32) NOT NULL COMMENT '发货快递公司名称',
  `expressno` varchar(64) NOT NULL COMMENT '发货快递单号',
  `note` varchar(126) NOT NULL COMMENT '备注',
  `orderid` char(32) NOT NULL,
  `wxuserid` int(11) NOT NULL COMMENT '冗余用户ID，方便查询用户的快递信息。',
...
--
-- 表的结构 `itboye_orders_item`
--

CREATE TABLE IF NOT EXISTS `itboye_orders_item` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `has_sku` tinyint(2) NOT NULL DEFAULT '0',
  `name` varchar(128) NOT NULL COMMENT '商品名称',
  `img` varchar(256) NOT NULL COMMENT '图片地址',
  `price` decimal(16,2) NOT NULL DEFAULT '0.00' COMMENT '商品价格(分）',
  `ori_price` decimal(16,2) NOT NULL DEFAULT '0.00' COMMENT '商品原价',
  `post_price` decimal(16,2) NOT NULL DEFAULT '0.00' COMMENT '商品运费',
  `sku_id` varchar(256) NOT NULL COMMENT '商品SKUID',
  `sku_desc` varchar(1024) NOT NULL COMMENT 'sku描述',
  `count` int(11) NOT NULL COMMENT '数量',
  `orders_id` bigint(20) NOT NULL,
  `createtime` int(11) NOT NULL,
  `p_id` int(11) NOT NULL,
  `pay_status` tinyint(2) NOT NULL COMMENT '0: 未支付 1: 已支付',
  PRIMARY KEY (`id`,`p_id`),
  KEY `fk_wytch_orders_item_wytch_orders1_idx` (`orders_id`),
  KEY `fk_itboye_orders_item_itboye_wxproduct1_idx` (`p_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单包含的单个商品信息' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `itboye_order_history`
--

CREATE TABLE IF NOT EXISTS `itboye_order_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `coupon_fee` int(11) NOT NULL COMMENT '现金券支付金额<=订单总金 额,订单总金额-现金券金额 为现金支付金额 \n',
  ...
  `wxuserid` int(11) unsigned DEFAULT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `itboye_pay_config`
--

CREATE TABLE IF NOT EXISTS `itboye_pay_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL COMMENT '支付名称',
  `config` text NOT NULL COMMENT '配置',
  `description` varchar(128) NOT NULL COMMENT '描述',
  `createtime` int(11) NOT NULL,
  `updatetime` int(11) NOT NULL,
  `wxaccountid` int(11) NOT NULL COMMENT '公众号ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `itboye_product` (
  ...
  `name` varchar(128) NOT NULL COMMENT '商品名称',
  `main_img` varchar(256) NOT NULL COMMENT '商品主图',
  `buy_limit` int(10) unsigned NOT NULL COMMENT '商品限购数量',
  `delivery_type` tinyint(2) NOT NULL COMMENT '运费类型(0-使用下面express字段的默认模板, 1-使用template_id代表的邮费模板, 详见邮费模板相关API)',
  `template_id` char(16) NOT NULL COMMENT '邮费模板ID',
  `express` varchar(1024) NOT NULL DEFAULT '' COMMENT '统一快递运费',
  `attrext_ispostfree` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否包邮(0-否, 1-是), 如果包邮delivery_info字段可省略',
  `attrext_ishasreceipt` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否提供发票(0-否, 1-是)',
  `attrext_isunderguaranty` tinyint(2) NOT NULL COMMENT '是否保修(0-否, 1-是)',
  `attrext_issupportreplace` tinyint(2) NOT NULL COMMENT '是否支持退换货(0-否, 1-是)',
  `loc_country` char(16) NOT NULL COMMENT '所属国家',
  `loc_province` char(32) NOT NULL COMMENT '所属省份',
  `loc_city` char(32) NOT NULL COMMENT '所属城市',
  `loc_address` varchar(128) NOT NULL COMMENT '所属区域',
  `has_sku` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否多规格',
  `ori_price` decimal(16,1) unsigned NOT NULL DEFAULT '0.0' COMMENT 'has_sku等于0时 有效。原价',
  `price` decimal(16,1) unsigned NOT NULL DEFAULT '0.0' COMMENT '微信价',
  `quantity` int(10) unsigned NOT NULL COMMENT '商品库存（仅has_sku＝0时）',
  `product_code` varchar(64) NOT NULL COMMENT '商品条码（仅has_sku＝0时）',
  `cate_id` char(16) NOT NULL COMMENT '商品分类ID',
  ...
  `properties` varchar(2000) NOT NULL DEFAULT '' COMMENT '商品属性\r\n',
  `img` varchar(3000) NOT NULL DEFAULT '' COMMENT '商品图片（最多10张）',
  `sku_info` varchar(3000) NOT NULL DEFAULT '' COMMENT 'sku_info',
  `detail` text NOT NULL COMMENT '详情',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `itboye_product`
--

INSERT INTO `itboye_product` (`id`, `product_id`, `uid`, `name`, `main_img`, `buy_limit`, `delivery_type`, `template_id`, `express`, `attrext_ispostfree`, `attrext_ishasreceipt`, `attrext_isunderguaranty`, `attrext_issupportreplace`, `loc_country`, `loc_province`, `loc_city`, `loc_address`, `has_sku`, `ori_price`, `price`, `quantity`, `product_code`, `cate_id`, `createtime`, `updatetime`, `onshelf`, `status`, `storeid`, `properties`, `img`, `sku_info`, `detail`) VALUES
(1, '5BBB2B0E-3C0C-40D5-885C-256C39196CD3', 1, '奥肯多', 'http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg', 0, -1, '', '', 1, 0, 0, 0, '中国', '四川省', '内江市', '威远县', 0, '100000.0', '69900.0', 3000, '', '2', 1435799088, 1435799088, 0, 1, 1, '1,1;2,5;', 'http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg,http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg,http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg,', '', ''),
(2, 'CDF1F1C0-4FE4-48C1-A3E4-31C37B32FE85', 1, '奥肯多咖啡', 'http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg', 0, -1, '', '', 1, 0, 0, 0, '中国', '四川省', '内江市', '威远县', 0, '99900.0', '79900.0', 10000, '', '2', 1435800342, 1435843765, 0, 1, 1, '1,1;2,3;', '', '', '');

-- --------------------------------------------------------

--
-- 表的结构 `itboye_product_group`
--

CREATE TABLE IF NOT EXISTS `itboye_product_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `g_id` int(11) NOT NULL,
  `p_id` int(11) NOT NULL,
  PRIMARY KEY (`id`,`g_id`,`p_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `itboye_product_sku`
--

CREATE TABLE IF NOT EXISTS `itboye_product_sku` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sku_id` varchar(1024) NOT NULL COMMENT 'sku信息, 参照上述sku_table的定义; \n格式 : "id1:vid1;id2:vid2"\n规则 : id_info的组合个数必须与sku_table个数一致(若商品无sku信息, 即商品为统一规格，则此处赋值为空字符串即可)',
  `ori_price` decimal(16,1) NOT NULL COMMENT 'sku原价(单位 : 分)',
  `price` decimal(16,1) NOT NULL COMMENT 'sku微信价',
  `quantity` int(11) NOT NULL COMMENT 'SKU库存',
  `product_code` varchar(64) NOT NULL COMMENT '商家商品编码',
  `createtime` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `itboye_sku` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sku_id` char(16) NOT NULL COMMENT 'SKU ID',
  `name` varchar(64) NOT NULL COMMENT 'SKU???',
  `cate_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `itboye_skuvalue`
--

CREATE TABLE IF NOT EXISTS `itboye_skuvalue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `itboye_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_phone` char(16) NOT NULL DEFAULT '',
  `weixin_number` varchar(256) NOT NULL DEFAULT '',
  `wxno` varchar(32) NOT NULL DEFAULT '' COMMENT '店铺微信号',
  `uid` int(11) DEFAULT NULL,
  `name` varchar(64) NOT NULL COMMENT '店铺名称',
  `desc` text NOT NULL COMMENT '店铺描述',
  `create_time` int(11) NOT NULL,
  `update_time` int(11) NOT NULL,
  `cate_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '店铺分类ID',
  `isopen` tinyint(2) NOT NULL DEFAULT '0' COMMENT '店铺是否开张',
  `exp` int(11) NOT NULL,
  `banner` varchar(256) NOT NULL DEFAULT '' COMMENT '店铺Banner',
  `logo` varchar(256) NOT NULL DEFAULT '' COMMENT '店铺logo',
  `notes` varchar(256) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `itboye_store`
--

INSERT INTO `itboye_store` (`id`, `service_phone`, `weixin_number`, `wxno`, `uid`, `name`, `desc`, `create_time`, `update_time`, `cate_id`, `isopen`, `exp`, `banner`, `logo`, `notes`) VALUES
(1, '05719999999', '[]', 'wx', 1, '奥肯多官方店铺', '', 1435798987, 1435798987, 11, 0, 0, 'http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg', 'http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg', '店铺简介'),
(2, '33', '[{"openid":"123456789","name":"\\u4f55\\u5fc5\\u90fd\\u6d4b\\u8bd5\\u8d26\\u6237"}]', '33', 1, '3333333', '', 1435842345, 1435842345, 9, 0, 0, '', '', '');
...
CREATE TABLE IF NOT EXISTS `itboye_suggest` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `text` text NOT NULL COMMENT '图片或其他详情内容',
  `create_time` int(11) NOT NULL,
  `update_time` int(11) NOT NULL,
  `status` tinyint(4) NOT NULL,
  `process_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: 等待确认  1: 客服已收到  2:客服已处理',
  `name` varchar(32) NOT NULL COMMENT '联系人姓名',
  `tel` char(16) NOT NULL COMMENT '联系人号码',
  `email` varchar(128) NOT NULL,
  `IP` bigint(20) NOT NULL COMMENT 'IP,提交者IP用来限制',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `itboye_suggest`
--

INSERT INTO `itboye_suggest` (`id`, `text`, `create_time`, `update_time`, `status`, `process_status`, `name`, `tel`, `email`, `IP`) VALUES
(1, '', 1435929688, 1435929688, 1, 0, '44', '13484379290', '', 0);
...
--
-- 转存表中的数据 `itboye_ucenter_app`
--

INSERT INTO `itboye_ucenter_app` (`id`, `app_id`, `title`, `url`, `ip`, `auth_key`, `sys_login`, `allow_ip`, `create_time`, `update_time`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `itboye_ucenter_member` (
  ...
  `reg_from` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '来源(0: 自主注册 !; qq 2: 微信 3: 新浪微博 4: 百度 99:其它)',
  PRIMARY KEY (`id`),
  UNIQUE KEY `username` (`username`),
  KEY `status` (`status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户表' AUTO_INCREMENT=203 ;

--
-- 转存表中的数据 `itboye_ucenter_member`
--

INSERT INTO `itboye_ucenter_member` (`id`, `username`, `password`, `mobile`, `email`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`, `reg_from`) VALUES
(1, 'itboye', '87d191982cdb4668644331382ec47ced', '', '', 1433570548, 0, 1435978933, 0, 1433570548, 1, 0);
...
--
-- 表的结构 `itboye_user_picture`
--

CREATE TABLE IF NOT EXISTS `itboye_user_picture` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `itboye_user_picture`
--

INSERT INTO `itboye_user_picture` (`id`, `path`, `uid`, `ori_name`, `savename`, `size`, `url`, `imgurl`, `md5`, `sha1`, `status`, `create_time`) VALUES
(1, '/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg', 1, '69525933_m.jpg', '5593b73028af4.jpg', 13617, '', '', '44510ca343d52daa4cd3041c11f6b1ea', '261adcbde0c53d71343ac36443c604cf87ddf802', 1, 1435744048),
(2, '/Uploads/WxshopPicture/2015-07-02/55953cbe21cc9.png', 1, '奥肯多会员手册5.png', '55953cbe21cc9.png', 65070, '', '', 'b924c876a980f9c8c5e2bc7d79cef58b', 'c0afbef185786a9ef363e6cb384c54c2e264682e', 1, 1435843774),
(3, '/Uploads/WxshopPicture/2015-07-02/55953e3d9f6b4.jpg', 1, '200x170_origenes_peru_molido.jpg', '55953e3d9f6b4.jpg', 2995, '', '', '7fbe82620809be0e73a7dee5a1a848c1', 'd140a2f1078cedc10dcfccd2a0bc74e7f6166330', 1, 1435844157);
...
CREATE TABLE IF NOT EXISTS `itboye_wallet` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `frozen_funds` decimal(16,2) NOT NULL COMMENT '冻结资金',
  `account_balance` decimal(16,2) NOT NULL COMMENT '账户余额',
...
--
-- 表的结构 `itboye_wallet_his`
--

CREATE TABLE IF NOT EXISTS `itboye_wallet_his` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `before_money` decimal(16,2) NOT NULL COMMENT '当前资金',
  `plus` decimal(16,2) NOT NULL COMMENT '+多少佣金',
  `minus` decimal(16,2) NOT NULL COMMENT '减多少佣金',
  `after_money` decimal(16,2) NOT NULL COMMENT '变化后资金',
  `create_time` int(11) NOT NULL COMMENT '变动时间',
  `reason` varchar(128) NOT NULL COMMENT '变动原因',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='佣金变动历史纪录' AUTO_INCREMENT=1 ;
...
--
-- 转存表中的数据 `itboye_weixin_log`
--

-- --------------------------------------------------------

--
-- 表的结构 `itboye_withdraw`
--

CREATE TABLE IF NOT EXISTS `itboye_withdraw` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '提现用户ID',
  `money` decimal(16,2) NOT NULL COMMENT '提现金额',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0: 待审核   1: 审核通过 2 : 审核失败',
  `reason` varchar(128) NOT NULL COMMENT '审核失败原因',
  `cash_account` varchar(32) NOT NULL COMMENT '账号\\卡号',
  `bank_branch` varchar(64) NOT NULL COMMENT '开户银行支行',
  `account_name` varchar(32) NOT NULL COMMENT '账号人姓名',
  `update_time` int(11) NOT NULL,
  `dtree_account_type` int(11) NOT NULL COMMENT '类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='提现记录表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `itboye_withdraw`
--

INSERT INTO `itboye_withdraw` (`id`, `uid`, `money`, `create_time`, `status`, `reason`, `cash_account`, `bank_branch`, `account_name`, `update_time`, `dtree_account_type`) VALUES
(1, 1, '10.00', 1435821438, 1, '12', '1253', '123', '123', 1435821438, 28);

-- --------------------------------------------------------

--
-- 表的结构 `itboye_wxaccount`
--

CREATE TABLE IF NOT EXISTS `itboye_wxaccount` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `uid` int(11) NOT NULL COMMENT '用户ID-用户登录账号ID',
  ...
  `ss_keyword` varchar(64) NOT NULL COMMENT '首页关键词',
  `qrcode` varchar(255) NOT NULL COMMENT '推广二维码地址',
  PRIMARY KEY (`id`),
  UNIQUE KEY `token_UNIQUE` (`token`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;

--
-- 转存表中的数据 `itboye_wxaccount`
--

INSERT INTO `itboye_wxaccount` (`id`, `wxname`, `appid`, `appsecret`, `encodingAESKey`, `token`, `uid`, `weixin`, `headerpic`, `createtime`, `updatetime`, `tplid`, `wxuid`, `ss_keyword`, `qrcode`) VALUES
(5, '奥肯多咖啡', '奥肯多咖啡', '奥肯多咖啡', 'sh4ajju01rd2nub6vwp4iqbzl8xe1i6i3g1spb7nzhp', 'enhfrsxk1435801334', 1, '奥肯多咖啡', 'http://new.weitonghui.com/Uploads/gfile/hmklem1405313222/552378253dece.jpg', 1435801334, 1435816513, 0, '奥肯多咖啡', '', 'http://localhost/github/20150606renren/Uploads/WxshopPicture/2015-07-01/5593b73028af4.jpg');
...
CREATE TABLE IF NOT EXISTS `itboye_wxmenu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wxaccount_id` int(11) NOT NULL,
  `name` char(40) NOT NULL COMMENT '菜单名称',
  `type` varchar(32) NOT NULL COMMENT '1、click：�',
  ...
  `createtime` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_cjfx_wxmenu_cjfx_wxaccount1_idx` (`wxaccount_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `itboye_wxreply_news`
--

CREATE TABLE IF NOT EXISTS `itboye_wxreply_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `pictureid` int(11) NOT NULL COMMENT 'picture表ID',
  `url` varchar(256) NOT NULL COMMENT '点击图文跳转的链接',
  `title` varchar(64) NOT NULL COMMENT '标题',
  `sort` tinyint(4) NOT NULL DEFAULT '0' COMMENT '排序，仅在多图文的情况下',
  PRIMARY KEY (`id`),
  KEY `fk_wxreply_cjfx_wxaccount1_idx` (`wxaccount_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `itboye_wxreply_text`
--

CREATE TABLE IF NOT EXISTS `itboye_wxreply_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyword` varchar(32) NOT NULL COMMENT '关键词',
...
--
-- 转存表中的数据 `itboye_wxreply_text`
--

INSERT INTO `itboye_wxreply_text` (`id`, `keyword`, `content`, `createtime`, `updatetime`, `wxaccount_id`) VALUES
(1, '123', '123213', 1435924426, 1435924426, 5);
...
CREATE TABLE IF NOT EXISTS `itboye_wxuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL COMMENT '用户ID',
  `nickname` varchar(32) NOT NULL COMMENT '昵称',
  `avatar` varchar(255) NOT NULL COMMENT '头像地址',
  `referrer` int(11) NOT NULL DEFAULT '0' COMMENT '推荐人id，wxuser',
  `openid` varchar(64) NOT NULL COMMENT '微信openid',
  `score` int(11) NOT NULL COMMENT '用户积分',
  `money` decimal(16,4) NOT NULL COMMENT '账户余额',
  `create_time` int(11) NOT NULL COMMENT '数据创建时间',
  `update_time` int(11) NOT NULL COMMENT '信息更新时间',
  `status` tinyint(4) NOT NULL COMMENT '数据状态,',
  `notes` varchar(45) NOT NULL COMMENT '备注',
  `wxaccount_id` int(11) NOT NULL COMMENT '公众号ID，外键',
  `sex` tinyint(4) NOT NULL COMMENT '性别',
  `province` varchar(32) NOT NULL COMMENT '省份',
  `city` varchar(32) NOT NULL COMMENT '城市',
  `country` varchar(32) NOT NULL COMMENT '国家',
  `subscribed` tinyint(2) NOT NULL DEFAULT '1' COMMENT '是否关注公众号',
  `subscribe_time` int(11) NOT NULL COMMENT '最后关注时间',
  `groupid` int(11) NOT NULL COMMENT '用户组ID',
  `exp` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_cjfx_wxuser_cjfx_wxaccount_idx` (`wxaccount_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=174 ;

--
-- 转存表中的数据 `itboye_wxuser`
--

INSERT INTO `itboye_wxuser` (`id`, `uid`, `nickname`, `avatar`, `referrer`, `openid`, `score`, `money`, `create_time`, `update_time`, `status`, `notes`, `wxaccount_id`, `sex`, `province`, `city`, `country`, `subscribed`, `subscribe_time`, `groupid`, `exp`) VALUES
(16, 45, '', '', 0, 'wijomFsgt', 0, '0.0000', 1435908515, 1435908515, 1, '', 1, 0, '', '', '中国', 1, 1435908515, 1, 0),
(17, 46, '', '', 0, 'QPVnhtArg', 0, '0.0000', 1435908517, 1435908517, 1, '', 1, 0, '', '', '中国', 1, 1435908517, 1, 0),
(18, 47, '', '', 0, 'LcpsBudAG', 0, '0.0000', 1435908518, 1435908518, 1, '', 1, 0, '', '', '中国', 1, 1435908518, 1, 0),
(19, 48, '', '', 0, 'WDydFZMkf', 0, '0.0000', 1435908540, 1435908540, 1, '', 1, 0, '', '', '中国', 1, 1435908540, 1, 0),
(20, 49, '', '', 0, 'JEBTpmCoa', 0, '0.0000', 1435908540, 1435908540, 1, '', 1, 0, '', '', '中国', 1, 1435908540, 1, 0),
(21, 50, '', '', 0, 'iQDjYXghn', 0, '0.0000', 1435908540, 1435908541, 1, '', 1, 0, '', '', '中国', 1, 1435908540, 1, 0),
(22, 51, '', '', 0, 'iswHIQXdA', 0, '0.0000', 1435908541, 1435908541, 1, '', 1, 0, '', '', '中国', 1, 1435908541, 1, 0),
(23, 52, '', '', 0, 'AnskUMrEc', 0, '0.0000', 1435908541, 1435908541, 1, '', 1, 0, '', '', '中国', 1, 1435908541, 1, 0),
(24, 53, '', '', 0, 'zidXpbaOD', 0, '0.0000', 1435908541, 1435908541, 1, '', 1, 0, '', '', '中国', 1, 1435908541, 1, 0),
(25, 54, '', '', 0, 'eYbLVrfEF', 0, '0.0000', 1435908541, 1435908541, 1, '', 1, 0, '', '', '中国', 1, 1435
(163, 192, '', '', 0, 'MbtOGwjdE', 0, '0.0000', 1435908568, 1435908568, 1, '', 1, 0, '', '', '中国', 1, 1435908568, 1, 0),
(164, 193, '', '', 0, 'CxoigyhqB', 0, '0.0000', 1435908568, 1435908568, 1, '', 1, 0, '', '', '中国', 1, 1435908568, 1, 0),
(165, 194, '', '', 0, 'rSntEzivk', 0, '0.0000', 1435908568, 1435908568, 1, '', 1, 0, '', '', '中国', 1, 1435908568, 1, 0),
(166, 195, '', '', 0, 'PGTgpLeUs', 0, '0.0000', 1435908568, 1435908568, 1, '', 1, 0, '', '', '中国', 1, 1435908568, 1, 0),
(167, 196, '', '', 0, 'cMTAKahCr', 0, '0.0000', 1435908569, 1435908569, 1, '', 1, 0, '', '', '中国', 1, 1435908569, 1, 0),
(168, 197, '', '', 0, 'yifduGSTF', 0, '0.0000', 1435908569, 1435908569, 1, '', 1, 0, '', '', '中国', 1, 1435908569, 1, 0),
(169, 198, '', '', 0, 'ulzafvyim', 0, '0.0000', 1435908569, 1435908569, 1, '', 1, 0, '', '', '中国', 1, 1435908569, 1, 0),
(170, 199, '', '', 0, 'rZjLOxnYa', 0, '0.0000', 1435908569, 1435908569, 1, '', 1, 0, '', '', '中国', 1, 1435908569, 1, 0),
(171, 200, '', '', 0, 'lvabLTGUP', 0, '0.0000', 1435908570, 1435908570, 1, '', 1, 0, '', '', '中国', 1, 1435908570, 1, 0),
(172, 201, '', '', 0, 'yrdDhOoiM', 0, '0.0000', 1435908570, 1435908570, 1, '', 1, 0, '', '', '中国', 1, 1435908570, 1, 0),
(173, 202, '', '', 0, 'gQAjTaEdG', 0, '0.0000', 1435909249, 1435909249, 1, '', 1, 0, '', '', '中国', 1, 1435909249, 1, 0);

-- --------------------------------------------------------

--
-- 表的结构 `itboye_wxuser_family`
--

CREATE TABLE IF NOT EXISTS `itboye_wxuser_family` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_1` int(11) NOT NULL DEFAULT '0' COMMENT '父一级',
  `parent_2` int(11) NOT NULL DEFAULT '0' COMMENT '父2级',
  `parent_3` int(11) NOT NULL DEFAULT '0' COMMENT '父3级',
  `parent_4` int(11) NOT NULL DEFAULT '0' COMMENT '父4级',
  `createtime` int(11) NOT NULL COMMENT '创建时间',
  `wxaccount_id` int(11) NOT NULL COMMENT 'wxaccount表id，外键\n',
  `uid` int(11) NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=182 ;

--
-- 转存表中的数据 `itboye_wxuser_family`
--

INSERT INTO `itboye_wxuser_family` (`id`, `parent_1`, `parent_2`, `parent_3`, `parent_4`, `createtime`, `wxaccount_id`, `uid`) VALUES
(24, 0, 0, 0, 0, 1435908515, -1, 45),
(25, 0, 0, 0, 0, 1435908517, -1, 46),
(26, 0, 0, 0, 0, 1435908518, -1, 47),
(27, 0, 0, 0, 0, 1435908540, -1, 48),
(28, 0, 0, 0, 0, 1435908540, -1, 49),
(29, 0, 0, 0, 0, 1435908540, -1, 50),
(30, 0, 0, 0, 0, 1435908541, -1, 51),
(31, 0, 0, 0, 0, 1435908541, -1, 52),
(140, 0, 0, 0, 0, 1435908561, -1, 161),
(141, 0, 0, 0, 0, 1435908562, -1, 162),
(142, 0, 0, 0, 0, 1435908562, -1, 163),
(143, 0, 0, 0, 0, 1435908562, -1, 164),
(144, 0, 0, 0, 0, 1435908562, -1, 165),
(145, 0, 0, 0, 0, 1435908562, -1, 166),
(146, 0, 0, 0, 0, 1435908563, -1, 167),
(147, 0, 0, 0, 0, 1435908563, -1, 168),
(148, 0, 0, 0, 0, 1435908563, -1, 169),
(149, 0, 0, 0, 0, 1435908563, -1, 170),
(150, 0, 0, 0, 0, 1435908563, -1, 171),
(151, 0, 0, 0, 0, 1435908564, -1, 172),
(152, 0, 0, 0, 0, 1435908564, -1, 173),
(153, 0, 0, 0, 0, 1435908564, -1, 174),
(154, 0, 0, 0, 0, 1435908564, -1, 175),
(155, 0, 0, 0, 0, 1435908564, -1, 176),
(156, 0, 0, 0, 0, 1435908565, -1, 177),
(157, 0, 0, 0, 0, 1435908565, -1, 178),
(158, 0, 0, 0, 0, 1435908565, -1, 179),
(159, 0, 0, 0, 0, 1435908565, -1, 180),
(160, 0, 0, 0, 0, 1435908565, -1, 181),
(161, 0, 0, 0, 0, 1435908566, -1, 182),
(162, 0, 0, 0, 0, 1435908566, -1, 183),
(163, 0, 0, 0, 0, 1435908566, -1, 184),
(164, 0, 0, 0, 0, 1435908566, -1, 185),
(165, 0, 0, 0, 0, 1435908566, -1, 186),
(166, 0, 0, 0, 0, 1435908567, -1, 187),
(167, 0, 0, 0, 0, 1435908567, -1, 188),
(168, 0, 0, 0, 0, 1435908567, -1, 189),
(169, 0, 0, 0, 0, 1435908567, -1, 190),
(170, 0, 0, 0, 0, 1435908568, -1, 191),
(171, 0, 0, 0, 0, 1435908568, -1, 192),
(172, 0, 0, 0, 0, 1435908568, -1, 193),
(173, 0, 0, 0, 0, 1435908568, -1, 194),
(174, 0, 0, 0, 0, 1435908568, -1, 195),
(175, 0, 0, 0, 0, 1435908569, -1, 196),
(176, 0, 0, 0, 0, 1435908569, -1, 197),
(177, 0, 0, 0, 0, 1435908569, -1, 198),
(178, 0, 0, 0, 0, 1435908569, -1, 199),
(179, 0, 0, 0, 0, 1435908570, -1, 200),
(180, 0, 0, 0, 0, 1435908570, -1, 201),
(181, 0, 0, 0, 0, 1435909249, -1, 202);

-- --------------------------------------------------------

--
-- 表的结构 `itboye_wxuser_group`
--

CREATE TABLE IF NOT EXISTS `itboye_wxuser_group` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(32) NOT NULL COMMENT '用户组名称',
  `description` varchar(128) NOT NULL COMMENT '用户组描述',
  `nextgroupid` int(10) NOT NULL DEFAULT '0' COMMENT '下一用户组id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14 ;

--
-- 转存表中的数据 `itboye_wxuser_group`
--

INSERT INTO `itboye_wxuser_group` (`id`, `name`, `description`, `nextgroupid`) VALUES
(1, '默认会员组', '默认，无法删除', 11),
(11, '一级分销商', '直属总部分销商', -1),
(12, '二级分销商', '由一级分销商推荐注册。', 0),
(13, '三级分销商', '由二级分销商推荐注册', 0);
